...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></div></section> <section class="filters-credits svelte-1uha8ag"><h3 class="svelte-1uha8ag">Aplicar filtros</h3> <p class="svelte-1uha8ag">Los filtros se aplican automaticamente al seleccionar opciones.</p> <p class="svelte-1uha8ag">Creditos: Datos del <a href="https://digital.gob.es/" target="_blank" rel="noopener noreferrer" class="svelte-1uha8ag">Ministerio para la Transformacion Digital y de la Funcion
